...
#include "rs_types.h"
    ...
    */
    typedef enum rs2_option
    {
        ...
        RS2_OPTION_MINZ_DISPARITY_SHIFT, /**< MinZ embedded filter: stereo disparity shift (pre-stream only) */
        RS2_OPTION_MINZ_THRESHOLD, /**< MinZ embedded filter: merge threshold in mm, 0..65000 (pre-stream only) */
        RS2_OPTION_MINZ_DOWNSCALE_RATIO, /**< MinZ embedded filter: secondary-frame downscale ratio, choices 1/2/4 (pre-stream only) */
