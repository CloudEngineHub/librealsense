    ...
    namespace gl
    {
        ...
        rs2::frame camera_renderer::process_frame(const rs2::frame_source& src, const rs2::frame& f)
        {
            ...
            if (dev.supports_info(RS2_CAMERA_INFO_NAME))
            {
                ...
                if (starts_with(dev_name, "RealSense D415")) index = 0;
                if (starts_with(dev_name, "RealSense D435") ||
                    starts_with(dev_name, "RealSense D436")) index = 1;
                if (starts_with(dev_name, "RealSense D45")) index = 2;
            };
