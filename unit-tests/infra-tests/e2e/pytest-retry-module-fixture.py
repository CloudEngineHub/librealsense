...
# and re-creates module-scoped fixtures between attempts (the "Fakeboi"
# preliminary-teardown trick in retry_plugin.py:207-215).
#
...
def test_module_fixture_is_recreated_on_retry(counted_module_fixture):
    ...
    Attempt 2 (retry): pytest-retry's preliminary teardown tears down the module
    fixture; setup re-runs → counted_module_fixture == 2; test asserts the
    counter incremented (i.e. fixture was actually re-instantiated)."""
